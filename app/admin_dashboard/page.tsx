...
export default function AdminDashboard() {
  ...
  const [itemKategori, setItemKategori] = useState('kopi');
  ...
  const [itemKategoriEdit, setItemKategoriEdit] = useState('kopi');
  ...
  const data_read = async (type: string) => {
    ...
    if (type == 'kopi') {
      setViewKategori('Minuman');
    } else if (type == 'makanan') {
      setViewKategori('Glosari')
    } else {
            ...
            <div className="modal-body">
              <form action="/api/data_write" encType="multipart/form-data" method="POST">
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control" name="harga_makanan" value={itemHarga} id="input-harga-makanan" onChange={(e) => setItemHarga(e.target.value)} />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  ...
                  <select className="form-select" id="exampleInputMenu" name="menu_kategori" onChange={(e) => setItemKategori(e.target.value)}>
                    <option value="kopi" selected>Minuman</option>
                    <option value="bumbu">Bumbu</option>
                    <option value="makanan">Glosari</option>
                    <option value="aneka_kletikan">Aneka Kletikan</option>
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="container-fluid text-center mt-3">
                <button type="button" className="btn btn-light w-75" onClick={() => data_read('kopi')} data-bs-dismiss="modal" id="btn-kategori-makanan">Minuman</button>
              </div>
              <div className="container-fluid text-center mt-3">
                <button type="button" className="btn btn-light w-75" onClick={() => data_read('bumbu')} data-bs-dismiss="modal" id="btn-kategori-minuman">Bumbu</button>
              </div>
              <div className="container-fluid text-center mt-3">
                <button type="button" className="btn btn-light w-75" onClick={() => data_read('makanan')} data-bs-dismiss="modal" id="btn-kategori-makanan">Gloseri</button>
              </div>
              <div className="container-fluid text-center mt-3">
                <button type="button" className="btn btn-light w-75" onClick={() => data_read('aneka_kletikan')} data-bs-dismiss="modal" id="btn-kategori-minuman">Aneka Kletikan</button>
              </div>
              <div className="container-fluid text-center mt-3">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form method="post">
                ...
                <div className="mb-3">
                  <label className="form-label">Harga</label>
                  <input type="text" className="form-control" name="harga_makanan" value={itemHargaEdit} id="harga_makanan_edit" onChange={(e) => setItemHargaEdit(e.target.value)}/>
                </div>
                <div className="mb-3">
                  <label className="form-label">Gambar</label>
